...
@Component
@Aspect
public class OperateLoggerAnnotation {

	/**
	 * <p>1.1.前置通知方法</p>  
	 */
	@Before("within(com.dragon.warIII.controller..*)")
	 ...
	 * <p>1.2.后置通知方法</p>  
	 */
	@AfterReturning("within(com.dragon.warIII.controller..*)")
	 ...
	 * <p>1.3.最终通知方法</p>  
	 */
	@After("within(com.dragon.warIII.controller..*)")
	 ...
	 * @throws Throwable 
	 */
	@Around("within(com.dragon.warIII.controller..*)")
	 ...
	 * @param e  
	 */
	@AfterThrowing(pointcut="within(com.dragon.warIII.controller..*)", throwing="e")
